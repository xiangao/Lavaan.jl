...
`Lavaan.jl` is a Julia port of the R package `lavaan` syntax. It currently
covers confirmatory factor analysis, path analysis, and structural equation
models.

## Why use it?

- Use lavaan-style model strings from Julia.
- Fit with Julia optimizers and automatic differentiation.
- Work with examples for ordinal, multilevel, crossed, GSEM, and SAM models.
